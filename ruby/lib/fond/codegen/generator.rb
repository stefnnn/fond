...
module Fond
  module Codegen
    ...
    class Generator
      ...
      # `Rails` can be defined (e.g. by requiring rails/generators) without an
      # application having booted; only defer to route lookups once one has.
      ...
      def initialize(pages: Fond::Registry.concrete_pages,
                      bindings: Fond::Codegen::Generator.rails_booted? ? Fond::Routes.page_bindings : [],
                      mutations: Fond::Registry.concrete_mutations,
                      mutation_bindings: Fond::Codegen::Generator.rails_booted? ? Fond::Routes.mutation_bindings : [],
